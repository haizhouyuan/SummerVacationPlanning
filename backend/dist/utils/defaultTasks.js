...
exports.initializeDefaultTasks = exports.defaultTasks = void 0;
...
const initializeDefaultTasks = async (systemUserId) => {
    try {
        console.log('Initializing default tasks...');
        for (const taskData of exports.defaultTasks) {
            const task = {
                ...taskData,
            ...
            await mongodb_1.collections.tasks.add(task);
        }
        console.log(`Successfully initialized ${exports.defaultTasks.length} default tasks`);
    }
    catch (error) {
...
//# sourceMappingURL=defaultTasks.js.map