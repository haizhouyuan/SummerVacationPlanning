...
const AppContent: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-100 to-secondary-100 flex items-center justify-center p-safe">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 border-2 border-primary-200 border-t-primary-600 mx-auto"></div>
          <p className="mt-3 text-sm sm:text-base text-gray-600">加载中...</p>
        </div>
      </div>
    );
  }
